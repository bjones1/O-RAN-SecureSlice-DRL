...
class multi_ue(gr.top_block):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "3UE Flowgraph")
        ...
        self.blocks_multiply_const_vxx_0_1_0_0 = blocks.multiply_const_cc(0.050)
        self.blocks_multiply_const_vxx_0_1_0 = blocks.multiply_const_cc(0.080)
        self.blocks_multiply_const_vxx_0_0_1 = blocks.multiply_const_cc(0.050)
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_cc(0.050)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(0.080)
