...
.. code-block:: bash
    ...
    make install
    ldconfig
    srslte_install_configs.sh user --force
    cd ../../
...
.. code-block:: bash
    ...
    https://github.com/joshuamoorexyz/DRL-Secure-Slicing.git
...
.. code-block:: bash
   ...
   sudo ip netns exec ue3 iperf3 -c 172.16.0.1 -p 5030 -i 1 -t 36000 -R -b 15M
